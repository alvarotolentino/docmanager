...
namespace Application.Mappings
{
    public class DocManagerProfile : Profile
    {
        ...
        {
            MappingDocumentDomain();
            MappingGroupDomain();
            MappingUserDomain();
        }

        private void MappingUserDomain()
        {
        ...
        private void MappingGroupDomain()
        {
        ...
        private void MappingDocumentDomain()
        {
            ...
            CreateMap<GetAllDocumentsQuery, GetUserDocumentsPaginated>();
            ...
            CreateMap<DeleteDocumentById, Document>();
